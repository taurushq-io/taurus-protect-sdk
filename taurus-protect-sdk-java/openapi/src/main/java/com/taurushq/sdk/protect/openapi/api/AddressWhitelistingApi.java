...
public class AddressWhitelistingApi {
     ...
     * @param whitelistedAddressId uint64; The ID of the whitelisted address for the attribute (required)
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     * @param whitelistedAddressId uint64; The whitelisted address ID for the attribute (required)
     ...
     * @param format defaults to &#x60;json&#x60;; can be &#x60;csv&#x60; or &#x60;json&#x60; (optional)
     * @param exchangeAccountId **Deprecated:** Use exchangeAccountIds instead (optional)
     * @param addressType Can be one of the following: &#x60;individual&#x60;, &#x60;exchange&#x60;, &#x60;baker&#x60;, &#x60;stakepool&#x60;, &#x60;contract&#x60;, &#x60;validator&#x60;, node, &#x60;fiatprovider&#x60; (optional)
     * @param query Will find a match in any part of the value. Filter applies to the following fields: &#x60;customerid&#x60;, &#x60;address&#x60;, &#x60;blockchain&#x60;, &#x60;label&#x60;, &#x60;memo&#x60;, &#x60;addresstype&#x60; (optional)
     * @param currency **Deprecated:** Use &#x60;blockchain&#x60; instead (optional)
     * @param scoreProvider **Deprecated:** Use &#x60;scoreFilter&#x60; instead. Can be either of the following: &#x60;scorechain&#x60;, &#x60;coinfirm&#x60;, &#x60;chainalysis&#x60;, &#x60;elliptic&#x60;, &#x60;trmlabs&#x60; (optional)
     * @param scoreInBelow numeric; **Deprecated:** Use &#x60;scoreFilter&#x60; instead (optional)
     * @param scoreOutBelow numeric; **Deprecated:** Use &#x60;scoreFilter&#x60; instead (optional)
     * @param scoreExclusive **Deprecated:** Use &#x60;scoreFilter&#x60; instead (optional)
     * @param exchangeAccountIds uint64; Array containing the list of IDs for exchange accounts (optional)
     * @param coinfirmScoreGreater uint64; **Deprecated:** Use &#x60;scoreFilter&#x60; instead (optional)
     * @param tags List of tags applied returned whitelisted addresses (optional)
     * @param chainalysisScoreGreater uint64; **Deprecated:** Use &#x60;scoreFilter&#x60; instead (optional)
     * @param blockchain Filter on the blockchain of the WLA. (optional)
     * @param addresses Filter on the specific addresses to return. This field is using the blockchain&#39;s native address syntax (optional)
     * @param network Name of the blockchain network, eg. &#x60;mainnet&#x60;, &#x60;testnet&#x60;, or &#x60;sepolia&#x60; (optional)
     * @param scoreFilterScoreProvider Specify the score provider to filter on, or empty.Each provider has associated filter parameters that can be set.Supported values: &#x60;scorechain&#x60;, &#x60;coinfirm&#x60;, &#x60;chainalysis&#x60;, &#x60;elliptic&#x60;, &#x60;trmlabs&#x60; (optional)
     ...
     * @param scoreFilterTrmlabsFiltersScoreGreater Filter addresses with an TRM Labs risk score above threshold. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call whitelistServiceExportWhitelistedAddressesCall(String format, String exchangeAccountId, String addressType, String query, String currency, String scoreProvider, String scoreInBelow, String scoreOutBelow, Boolean scoreExclusive, List<String> exchangeAccountIds, String coinfirmScoreGreater, List<String> tags, String chainalysisScoreGreater, String blockchain, List<String> addresses, String network, String scoreFilterScoreProvider, String scoreFilterScorechainFiltersScoreInBelow, String scoreFilterScorechainFiltersScoreOutBelow, Boolean scoreFilterScorechainFiltersScoreExclusive, String scoreFilterCoinfirmFiltersScoreGreater, String scoreFilterChainalysisFiltersScoreGreater, String scoreFilterEllipticFiltersScoreGreater, String scoreFilterTrmlabsFiltersScoreGreater, final ApiCallback _callback) throws ApiException {
        ...
        if (scoreFilterTrmlabsFiltersScoreGreater != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("scoreFilter.trmlabsFilters.scoreGreater", scoreFilterTrmlabsFiltersScoreGreater));
        }
     ...
     * @param limit uint64; Return maximum &#x60;limit&#x60; items for a query; Max 100. (optional)
     * @param offset uint64; Start retrieving items starting at &#x60;offset&#x60; id (optional)
     * @param exchangeAccountId uint64; **Deprecated:** Use exchangeAccountIds instead (optional)
     * @param addressType Can be one of the following: &#x60;individual&#x60;, &#x60;exchange&#x60;, &#x60;baker&#x60;, &#x60;stakepool&#x60;, &#x60;contract&#x60;, &#x60;validator&#x60;, node, &#x60;fiatprovider&#x60; (optional)
     * @param query Will find a match in any part of the value. Filter applies to the following fields: &#x60;customerid&#x60;, &#x60;address&#x60;, &#x60;blockchain&#x60;, &#x60;label&#x60;, &#x60;memo&#x60;, &#x60;addresstype&#x60; (optional)
     * @param currency **Deprecated:** Use &#x60;blockchain&#x60; instead (optional)
     * @param scoreProvider **Deprecated:** Use &#x60;scoreFilter&#x60; instead. Can be either of the following: &#x60;scorechain&#x60;, &#x60;coinfirm&#x60;, &#x60;chainalysis&#x60;, &#x60;elliptic&#x60;, &#x60;trmlabs&#x60; (optional)
     ...
     * @param chainalysisScoreGreater uint64; **Deprecated:** Use &#x60;scoreFilter&#x60; instead (optional)
     * @param contractType **Deprecated:** Use &#x60;contractTypes&#x60; instead (optional)
     * @param allowedForAddressId uint64; Filter addresses allowed to receive funds from this address id (optional)
     * @param allowedForWalletId uint64; Filter addresses allowed to receive funds from this wallet id. Will be ignored if allowedForAddressId is filled (optional)
     * @param blockchain Filter on the blockchain of the WLA. (optional)
     * @param includeForApproval If true, include also addresses waiting for approval in the results. (optional)
     * @param addresses Filter on the specific addresses to return. This field is using the blockchain&#39;s native address syntax (optional)
     * @param network Name of the blockchain network, eg. &#x60;mainnet&#x60;, &#x60;testnet&#x60;, or &#x60;sepolia&#x60; (optional)
     * @param ids uint64; List of IDs to return (optional)
     * @param tnParticipantID uuid; UUID of the Taurus-NETWORK participant to whom the address belongs (optional)
     * @param scoreFilterScoreProvider Specify the score provider to filter on, or empty.Each provider has associated filter parameters that can be set.Supported values: &#x60;scorechain&#x60;, &#x60;coinfirm&#x60;, &#x60;chainalysis&#x60;, &#x60;elliptic&#x60;, &#x60;trmlabs&#x60; (optional)
     * @param scoreFilterScorechainFiltersScoreInBelow Filter addresses under a Scorechain incoming score threshold. (optional)
     * @param scoreFilterScorechainFiltersScoreOutBelow Filter addresses under a Scorechain outgoing score threshold. (optional)
     * @param scoreFilterScorechainFiltersScoreExclusive By default when both Scorechain scores scoreInBelow and scoreOutBelow are provided, it returns the addresses matching (scoreInBelow AND scoreOutBelow). When scoreExclusive is set to true, it will return the addresses matching (scoreInBelow OR scoreOutBelow). (optional)
     ...
     * @param scoreFilterEllipticFiltersScoreGreater Filter addresses with an Elliptic risk score above threshold. (optional)
     * @param scoreFilterTrmlabsFiltersScoreGreater Filter addresses with an TRM Labs risk score above threshold. (optional)
     * @param lastIncomingTxFromWhitelistedAddress Filtered addresses with the last incoming transaction older than lastIncomingTransactionDate  won&#39;t appear in the result. The default value is never (optional)
     * @param contractTypes Filter addresses by multiple Contract Types. Can be any of: &#x60;GENERIC&#x60;, &#x60;CMTA20&#x60;, &#x60;CMTA20-KYC&#x60;, &#x60;CMTA20-RULEENGINE&#x60;, &#x60;CMTAT&#x60;, &#x60;ERC20&#x60;, &#x60;DEFI&#x60;, &#x60;ERC2771-PROXY-ADMIN&#x60;, &#x60;TERC1155A&#x60;, &#x60;GSN_FORWARDER&#x60;, &#x60;OPEN_ZEPPELIN_FORWARDER&#x60;, &#x60;TAURUS_CONTRACT_CREATOR&#x60;, &#x60;SMARTPY-FA2&#x60;, &#x60;SMARTPY-FA12&#x60;, &#x60;ASA&#x60;, &#x60;FIGMENT_STAKING&#x60; (optional)
    ...
    public okhttp3.Call whitelistServiceGetWhitelistedAddressesCall(String limit, String offset, String exchangeAccountId, String addressType, String query, String currency, String scoreProvider, String scoreInBelow, String scoreOutBelow, Boolean scoreExclusive, Boolean rulesContainerNormalized, List<String> exchangeAccountIds, String coinfirmScoreGreater, List<String> tagIDs, String chainalysisScoreGreater, String contractType, String allowedForAddressId, String allowedForWalletId, String blockchain, Boolean includeForApproval, List<String> addresses, String network, List<String> ids, String tnParticipantID, String scoreFilterScoreProvider, String scoreFilterScorechainFiltersScoreInBelow, String scoreFilterScorechainFiltersScoreOutBelow, Boolean scoreFilterScorechainFiltersScoreExclusive, String scoreFilterCoinfirmFiltersScoreGreater, String scoreFilterChainalysisFiltersScoreGreater, String scoreFilterEllipticFiltersScoreGreater, String scoreFilterTrmlabsFiltersScoreGreater, OffsetDateTime lastIncomingTxFromWhitelistedAddress, List<String> contractTypes, String attributeFiltersJson, String attributeFiltersOperator, final ApiCallback _callback) throws ApiException {
        ...
        if (lastIncomingTxFromWhitelistedAddress != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("lastIncomingTxFromWhitelistedAddress", lastIncomingTxFromWhitelistedAddress));
        }

        if (contractTypes != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "contractTypes", contractTypes));
        }
    ...
    public ApiResponse<TgvalidatordGetSignedWhitelistedAddressEnvelopesReply> whitelistServiceGetWhitelistedAddressesWithHttpInfo(String limit, String offset, String exchangeAccountId, String addressType, String query, String currency, String scoreProvider, String scoreInBelow, String scoreOutBelow, Boolean scoreExclusive, Boolean rulesContainerNormalized, List<String> exchangeAccountIds, String coinfirmScoreGreater, List<String> tagIDs, String chainalysisScoreGreater, String contractType, String allowedForAddressId, String allowedForWalletId, String blockchain, Boolean includeForApproval, List<String> addresses, String network, List<String> ids, String tnParticipantID, String scoreFilterScoreProvider, String scoreFilterScorechainFiltersScoreInBelow, String scoreFilterScorechainFiltersScoreOutBelow, Boolean scoreFilterScorechainFiltersScoreExclusive, String scoreFilterCoinfirmFiltersScoreGreater, String scoreFilterChainalysisFiltersScoreGreater, String scoreFilterEllipticFiltersScoreGreater, String scoreFilterTrmlabsFiltersScoreGreater, OffsetDateTime lastIncomingTxFromWhitelistedAddress, List<String> contractTypes, String attributeFiltersJson, String attributeFiltersOperator) throws ApiException {
        okhttp3.Call localVarCall = whitelistServiceGetWhitelistedAddressesValidateBeforeCall(limit, offset, exchangeAccountId, addressType, query, currency, scoreProvider, scoreInBelow, scoreOutBelow, scoreExclusive, rulesContainerNormalized, exchangeAccountIds, coinfirmScoreGreater, tagIDs, chainalysisScoreGreater, contractType, allowedForAddressId, allowedForWalletId, blockchain, includeForApproval, addresses, network, ids, tnParticipantID, scoreFilterScoreProvider, scoreFilterScorechainFiltersScoreInBelow, scoreFilterScorechainFiltersScoreOutBelow, scoreFilterScorechainFiltersScoreExclusive, scoreFilterCoinfirmFiltersScoreGreater, scoreFilterChainalysisFiltersScoreGreater, scoreFilterEllipticFiltersScoreGreater, scoreFilterTrmlabsFiltersScoreGreater, lastIncomingTxFromWhitelistedAddress, contractTypes, attributeFiltersJson, attributeFiltersOperator, null);
     ...
     * @param limit uint64; The amount of unapproved whitelisted address returned per request. Max 100. (optional)
     * @param offset uint64; The offset from which to begin selection of unapproved whitelisted addresses. (optional)
     * @param ids uint64 Array; The ids to filter your requests selection by. (optional)
     * @param blockchain The blockchain associated with the unapproved whitelisted addresses. (ex. eth, btc) (optional)
     * @param addressType The type of unapproved whitelisted address (ex. individual, exchange, baker, contract, stakepool, validator, node, fiatprovider). (optional)
     * @param query A search query to filter your request with. Will search the label or address fields. (optional)
     * @param network The network of the associated blockchain the address is in. (ex. mainnet, sepolia) (optional)
     * @param includeAlreadySignedByUser Set to true to include the pending approval whitelisted addresses already signed by the user. Default: false (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
