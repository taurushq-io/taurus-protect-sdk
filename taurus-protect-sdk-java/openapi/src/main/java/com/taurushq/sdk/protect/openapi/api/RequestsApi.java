...
import com.taurushq.sdk.protect.openapi.model.MaintenanceServiceForceKillBundleBody;
import com.taurushq.sdk.protect.openapi.model.MaintenanceServiceForceKillRequestBody;
...
import com.taurushq.sdk.protect.openapi.model.TgvalidatordCreateETHUnstakeRequestRequest;
import com.taurushq.sdk.protect.openapi.model.TgvalidatordCreateFiatProviderDepositRequestRequest;
import com.taurushq.sdk.protect.openapi.model.TgvalidatordCreateFiatProviderTransferRequestRequest;
import com.taurushq.sdk.protect.openapi.model.TgvalidatordCreateFiatProviderWithdrawalRequestRequest;
...
import com.taurushq.sdk.protect.openapi.model.TgvalidatordGetAutoTransferEventHandlerByIdReply;
import com.taurushq.sdk.protect.openapi.model.TgvalidatordGetAutoTransferEventHandlersReply;
...
import com.taurushq.sdk.protect.openapi.model.TgvalidatordStakeETHRequest;
...
public class RequestsApi {
    ...
    /**
     * Build call for maintenanceServiceForceKillBundle
     * @param requestBundleId The ID of the request bundle to force kill (required)
     * @param body  (required)
     ...
     */
    public okhttp3.Call maintenanceServiceForceKillBundleCall(String requestBundleId, MaintenanceServiceForceKillBundleBody body, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/rest/v1/maintenance/request_bundles/{requestBundleId}/force_kill"
            .replace("{" + "requestBundleId" + "}", localVarApiClient.escapeString(requestBundleId.toString()));
    ...
    private okhttp3.Call maintenanceServiceForceKillBundleValidateBeforeCall(String requestBundleId, MaintenanceServiceForceKillBundleBody body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestBundleId' is set
        if (requestBundleId == null) {
            throw new ApiException("Missing the required parameter 'requestBundleId' when calling maintenanceServiceForceKillBundle(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling maintenanceServiceForceKillBundle(Async)");
        }

        return maintenanceServiceForceKillBundleCall(requestBundleId, body, _callback);
     ...
     */
    public Object maintenanceServiceForceKillBundle(String requestBundleId, MaintenanceServiceForceKillBundleBody body) throws ApiException {
        ApiResponse<Object> localVarResp = maintenanceServiceForceKillBundleWithHttpInfo(requestBundleId, body);
     ...
     */
    public ApiResponse<Object> maintenanceServiceForceKillBundleWithHttpInfo(String requestBundleId, MaintenanceServiceForceKillBundleBody body) throws ApiException {
        okhttp3.Call localVarCall = maintenanceServiceForceKillBundleValidateBeforeCall(requestBundleId, body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Force kill a request bundle (asynchronously)
     * This endpoint force kills a request bundle and all its contained requests. If not broadcast, marks as PERMANENT_FAILURE. If broadcast, waits for completion and then kills on failure.
     * @param requestBundleId The ID of the request bundle to force kill (required)
     * @param body  (required)
     ...
     */
    public okhttp3.Call maintenanceServiceForceKillBundleAsync(String requestBundleId, MaintenanceServiceForceKillBundleBody body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = maintenanceServiceForceKillBundleValidateBeforeCall(requestBundleId, body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for maintenanceServiceForceKillRequest
     * @param requestId The ID of the request to force kill (required)
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call maintenanceServiceForceKillRequestCall(String requestId, MaintenanceServiceForceKillRequestBody body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/maintenance/requests/{requestId}/force_kill"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call maintenanceServiceForceKillRequestValidateBeforeCall(String requestId, MaintenanceServiceForceKillRequestBody body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestId' is set
        if (requestId == null) {
            throw new ApiException("Missing the required parameter 'requestId' when calling maintenanceServiceForceKillRequest(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling maintenanceServiceForceKillRequest(Async)");
        }

        return maintenanceServiceForceKillRequestCall(requestId, body, _callback);
     ...
     */
    public Object maintenanceServiceForceKillRequest(String requestId, MaintenanceServiceForceKillRequestBody body) throws ApiException {
        ApiResponse<Object> localVarResp = maintenanceServiceForceKillRequestWithHttpInfo(requestId, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> maintenanceServiceForceKillRequestWithHttpInfo(String requestId, MaintenanceServiceForceKillRequestBody body) throws ApiException {
        okhttp3.Call localVarCall = maintenanceServiceForceKillRequestValidateBeforeCall(requestId, body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Force kill a request (asynchronously)
     * This endpoint force kills a request. If the request has not been broadcast, it marks it as PERMANENT_FAILURE and kills the containing bundle. If broadcast, it waits for completion and then kills on failure.
     * @param requestId The ID of the request to force kill (required)
     * @param body  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call maintenanceServiceForceKillRequestAsync(String requestId, MaintenanceServiceForceKillRequestBody body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = maintenanceServiceForceKillRequestValidateBeforeCall(requestId, body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for requestServiceCreateETHUnstakeRequest
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call requestServiceCreateETHUnstakeRequestCall(TgvalidatordCreateETHUnstakeRequestRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/staking/eth_unstake";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceCreateETHUnstakeRequestValidateBeforeCall(TgvalidatordCreateETHUnstakeRequestRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling requestServiceCreateETHUnstakeRequest(Async)");
        }

        return requestServiceCreateETHUnstakeRequestCall(body, _callback);
     ...
     */
    public TgvalidatordCreateRequestReply requestServiceCreateETHUnstakeRequest(TgvalidatordCreateETHUnstakeRequestRequest body) throws ApiException {
        ApiResponse<TgvalidatordCreateRequestReply> localVarResp = requestServiceCreateETHUnstakeRequestWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordCreateRequestReply> requestServiceCreateETHUnstakeRequestWithHttpInfo(TgvalidatordCreateETHUnstakeRequestRequest body) throws ApiException {
        okhttp3.Call localVarCall = requestServiceCreateETHUnstakeRequestValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create an ETH unstake request (asynchronously)
     * This endpoint will create an ETH unstake request
     * @param body  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call requestServiceCreateETHUnstakeRequestAsync(TgvalidatordCreateETHUnstakeRequestRequest body, final ApiCallback<TgvalidatordCreateRequestReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceCreateETHUnstakeRequestValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for requestServiceCreateFiatProviderDepositRequest
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call requestServiceCreateFiatProviderDepositRequestCall(TgvalidatordCreateFiatProviderDepositRequestRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/fiat_provider/deposit";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceCreateFiatProviderDepositRequestValidateBeforeCall(TgvalidatordCreateFiatProviderDepositRequestRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling requestServiceCreateFiatProviderDepositRequest(Async)");
        }

        return requestServiceCreateFiatProviderDepositRequestCall(body, _callback);
     ...
     */
    public TgvalidatordCreateRequestReply requestServiceCreateFiatProviderDepositRequest(TgvalidatordCreateFiatProviderDepositRequestRequest body) throws ApiException {
        ApiResponse<TgvalidatordCreateRequestReply> localVarResp = requestServiceCreateFiatProviderDepositRequestWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordCreateRequestReply> requestServiceCreateFiatProviderDepositRequestWithHttpInfo(TgvalidatordCreateFiatProviderDepositRequestRequest body) throws ApiException {
        okhttp3.Call localVarCall = requestServiceCreateFiatProviderDepositRequestValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a fiat provider deposit request (asynchronously)
     * This endpoint creates a fiat provider deposit request.  Required role: **RequestCreator**. This API can be made idempotent by generating an ID for the Request beforehand and passing it as the externalRequestID attribute
     * @param body  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call requestServiceCreateFiatProviderDepositRequestAsync(TgvalidatordCreateFiatProviderDepositRequestRequest body, final ApiCallback<TgvalidatordCreateRequestReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceCreateFiatProviderDepositRequestValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for requestServiceCreateFiatProviderTransferRequest
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call requestServiceCreateFiatProviderTransferRequestCall(TgvalidatordCreateFiatProviderTransferRequestRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/fiat_provider/transfer";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceCreateFiatProviderTransferRequestValidateBeforeCall(TgvalidatordCreateFiatProviderTransferRequestRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling requestServiceCreateFiatProviderTransferRequest(Async)");
        }

        return requestServiceCreateFiatProviderTransferRequestCall(body, _callback);
     ...
     */
    public TgvalidatordCreateRequestReply requestServiceCreateFiatProviderTransferRequest(TgvalidatordCreateFiatProviderTransferRequestRequest body) throws ApiException {
        ApiResponse<TgvalidatordCreateRequestReply> localVarResp = requestServiceCreateFiatProviderTransferRequestWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordCreateRequestReply> requestServiceCreateFiatProviderTransferRequestWithHttpInfo(TgvalidatordCreateFiatProviderTransferRequestRequest body) throws ApiException {
        okhttp3.Call localVarCall = requestServiceCreateFiatProviderTransferRequestValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a fiat provider transfer request (asynchronously)
     * This endpoint creates a fiat provider transfer request.  Required role: **RequestCreator**. This API can be made idempotent by generating an ID for the Request beforehand and passing it as the externalRequestID attribute
     * @param body  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call requestServiceCreateFiatProviderTransferRequestAsync(TgvalidatordCreateFiatProviderTransferRequestRequest body, final ApiCallback<TgvalidatordCreateRequestReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceCreateFiatProviderTransferRequestValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for requestServiceCreateFiatProviderWithdrawalRequest
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call requestServiceCreateFiatProviderWithdrawalRequestCall(TgvalidatordCreateFiatProviderWithdrawalRequestRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/fiat_provider/withdrawal";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceCreateFiatProviderWithdrawalRequestValidateBeforeCall(TgvalidatordCreateFiatProviderWithdrawalRequestRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling requestServiceCreateFiatProviderWithdrawalRequest(Async)");
        }

        return requestServiceCreateFiatProviderWithdrawalRequestCall(body, _callback);
     ...
     */
    public TgvalidatordCreateRequestReply requestServiceCreateFiatProviderWithdrawalRequest(TgvalidatordCreateFiatProviderWithdrawalRequestRequest body) throws ApiException {
        ApiResponse<TgvalidatordCreateRequestReply> localVarResp = requestServiceCreateFiatProviderWithdrawalRequestWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordCreateRequestReply> requestServiceCreateFiatProviderWithdrawalRequestWithHttpInfo(TgvalidatordCreateFiatProviderWithdrawalRequestRequest body) throws ApiException {
        okhttp3.Call localVarCall = requestServiceCreateFiatProviderWithdrawalRequestValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a fiat provider withdrawal request (asynchronously)
     * This endpoint creates a fiat provider withdrawal request.  Required role: **RequestCreator**. This API can be made idempotent by generating an ID for the Request beforehand and passing it as the externalRequestID attribute
     * @param body  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call requestServiceCreateFiatProviderWithdrawalRequestAsync(TgvalidatordCreateFiatProviderWithdrawalRequestRequest body, final ApiCallback<TgvalidatordCreateRequestReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceCreateFiatProviderWithdrawalRequestValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for requestServiceGetAutoTransferEventHandlerById
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call requestServiceGetAutoTransferEventHandlerByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/auto_transfer_handlers/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceGetAutoTransferEventHandlerByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling requestServiceGetAutoTransferEventHandlerById(Async)");
        }

        return requestServiceGetAutoTransferEventHandlerByIdCall(id, _callback);
     ...
     */
    public TgvalidatordGetAutoTransferEventHandlerByIdReply requestServiceGetAutoTransferEventHandlerById(String id) throws ApiException {
        ApiResponse<TgvalidatordGetAutoTransferEventHandlerByIdReply> localVarResp = requestServiceGetAutoTransferEventHandlerByIdWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * This endpoint returns the auto-transfers event handler for the given id.
     * @param id  (required)
     * @return ApiResponse&lt;TgvalidatordGetAutoTransferEventHandlerByIdReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TgvalidatordGetAutoTransferEventHandlerByIdReply> requestServiceGetAutoTransferEventHandlerByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = requestServiceGetAutoTransferEventHandlerByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetAutoTransferEventHandlerByIdReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get auto-transfer event handler by id (asynchronously)
     * This endpoint returns the auto-transfers event handler for the given id.
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call requestServiceGetAutoTransferEventHandlerByIdAsync(String id, final ApiCallback<TgvalidatordGetAutoTransferEventHandlerByIdReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceGetAutoTransferEventHandlerByIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetAutoTransferEventHandlerByIdReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for requestServiceGetAutoTransferEventHandlers
     ...
     * @param status Filter handlers by status: &#39;active&#39; or &#39;disabled&#39;. Required if no wallet ID is provided. (optional)
     * @param blockchain Filter handlers by blockchain: &#39;ETH&#39; or &#39;SOL&#39;. Required if no wallet ID is provided. (optional)
     * @param network Filter handlers by network. Required if no wallet ID is provided. (optional)
     * @param monitoredWalletId Get handlers linked to given monitored native wallet. Status and Blockchain filters are ignored if this is set. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call requestServiceGetAutoTransferEventHandlersCall(String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, String blockchain, String network, String monitoredWalletId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/auto_transfer_handlers";
        ...
        if (monitoredWalletId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("monitoredWalletId", monitoredWalletId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceGetAutoTransferEventHandlersValidateBeforeCall(String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, String blockchain, String network, String monitoredWalletId, final ApiCallback _callback) throws ApiException {
        return requestServiceGetAutoTransferEventHandlersCall(cursorCurrentPage, cursorPageRequest, cursorPageSize, status, blockchain, network, monitoredWalletId, _callback);
     ...
     */
    public TgvalidatordGetAutoTransferEventHandlersReply requestServiceGetAutoTransferEventHandlers(String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, String blockchain, String network, String monitoredWalletId) throws ApiException {
        ApiResponse<TgvalidatordGetAutoTransferEventHandlersReply> localVarResp = requestServiceGetAutoTransferEventHandlersWithHttpInfo(cursorCurrentPage, cursorPageRequest, cursorPageSize, status, blockchain, network, monitoredWalletId);
        return localVarResp.getData();
    }
     ...
     * @param network Filter handlers by network. Required if no wallet ID is provided. (optional)
     * @param monitoredWalletId Get handlers linked to given monitored native wallet. Status and Blockchain filters are ignored if this is set. (optional)
     * @return ApiResponse&lt;TgvalidatordGetAutoTransferEventHandlersReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TgvalidatordGetAutoTransferEventHandlersReply> requestServiceGetAutoTransferEventHandlersWithHttpInfo(String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, String blockchain, String network, String monitoredWalletId) throws ApiException {
        okhttp3.Call localVarCall = requestServiceGetAutoTransferEventHandlersValidateBeforeCall(cursorCurrentPage, cursorPageRequest, cursorPageSize, status, blockchain, network, monitoredWalletId, null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetAutoTransferEventHandlersReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get auto-transfer event handlers (asynchronously)
     * This endpoint returns auto-transfers event handlers with some optional filtering parameters.
     * @param cursorCurrentPage Base64-encoded string representing the current window of data (optional)
     * @param cursorPageRequest The page to request, w.r.t the current page. Can be one of &#x60;FIRST&#x60;, &#x60;PREVIOUS&#x60;, &#x60;NEXT&#x60;, &#x60;LAST&#x60; (optional)
     * @param cursorPageSize The size of the page requested. The handling service should impose a hard limit on this (optional)
     ...
     */
    public okhttp3.Call requestServiceGetAutoTransferEventHandlersAsync(String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, String blockchain, String network, String monitoredWalletId, final ApiCallback<TgvalidatordGetAutoTransferEventHandlersReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceGetAutoTransferEventHandlersValidateBeforeCall(cursorCurrentPage, cursorPageRequest, cursorPageSize, status, blockchain, network, monitoredWalletId, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetAutoTransferEventHandlersReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param ids uint64; Filter for specific requests, identified by their unique ID (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param currencyID Filter on currency ID. Get valid IDs from the [currencies endpoint](https://docs.taurushq.com/protect-capital/reference/walletservice_getcurrency) (optional)
     * @param types Filter on request types. Examples: &#x60;&#x60;payment&#x60;&#x60;, &#x60;&#x60;function_call&#x60;&#x60;, &#x60;&#x60;ada_delegate&#x60;&#x60;, &#x60;&#x60;sol_token_burn&#x60;&#x60;, &#x60;&#x60;xtz_stake&#x60;&#x60; ... (optional)
     * @param ids Filter on specific Requests IDs. An empty list will retrieve all request IDs for approval (optional)
     * @param cursorCurrentPage Base64-encoded string representing the current window of data (optional)
     * @param cursorPageRequest The page to request, w.r.t the current page. Can be one of &#x60;FIRST&#x60;, &#x60;PREVIOUS&#x60;, &#x60;NEXT&#x60;, &#x60;LAST&#x60; (optional)
     * @param cursorPageSize The size of the page requested. The handling service should impose a hard limit on this (optional)
     ...
     * @param excludeTypes Exclude request types. Examples: &#x60;&#x60;cosmos_delegate&#x60;&#x60;, &#x60;&#x60;hedera_staking&#x60;&#x60;, &#x60;&#x60;ada_delegate&#x60;&#x60;, &#x60;&#x60;xlm_offer_buy&#x60;&#x60;, &#x60;&#x60;xtz_unstake&#x60;&#x60; ... (optional)
     * @param externalRequestIDs Filter on external request ID (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call requestServiceGetRequestsForApprovalV2Call(String currencyID, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> excludeTypes, List<String> externalRequestIDs, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (externalRequestIDs != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "externalRequestIDs", externalRequestIDs));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceGetRequestsForApprovalV2ValidateBeforeCall(String currencyID, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> excludeTypes, List<String> externalRequestIDs, final ApiCallback _callback) throws ApiException {
        return requestServiceGetRequestsForApprovalV2Call(currencyID, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, excludeTypes, externalRequestIDs, _callback);
     ...
     */
    public TgvalidatordGetRequestsV2Reply requestServiceGetRequestsForApprovalV2(String currencyID, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> excludeTypes, List<String> externalRequestIDs) throws ApiException {
        ApiResponse<TgvalidatordGetRequestsV2Reply> localVarResp = requestServiceGetRequestsForApprovalV2WithHttpInfo(currencyID, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, excludeTypes, externalRequestIDs);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordGetRequestsV2Reply> requestServiceGetRequestsForApprovalV2WithHttpInfo(String currencyID, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> excludeTypes, List<String> externalRequestIDs) throws ApiException {
        okhttp3.Call localVarCall = requestServiceGetRequestsForApprovalV2ValidateBeforeCall(currencyID, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, excludeTypes, externalRequestIDs, null);
    ...
    public okhttp3.Call requestServiceGetRequestsForApprovalV2Async(String currencyID, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> excludeTypes, List<String> externalRequestIDs, final ApiCallback<TgvalidatordGetRequestsV2Reply> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = requestServiceGetRequestsForApprovalV2ValidateBeforeCall(currencyID, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, excludeTypes, externalRequestIDs, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetRequestsV2Reply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call requestServiceGetRequestsV2Call(OffsetDateTime from, OffsetDateTime to, String currencyID, List<String> statuses, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> externalRequestIDs, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call requestServiceGetRequestsV2ValidateBeforeCall(OffsetDateTime from, OffsetDateTime to, String currencyID, List<String> statuses, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> externalRequestIDs, final ApiCallback _callback) throws ApiException {
        return requestServiceGetRequestsV2Call(from, to, currencyID, statuses, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, externalRequestIDs, _callback);
     ...
     */
    public TgvalidatordGetRequestsV2Reply requestServiceGetRequestsV2(OffsetDateTime from, OffsetDateTime to, String currencyID, List<String> statuses, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> externalRequestIDs) throws ApiException {
        ApiResponse<TgvalidatordGetRequestsV2Reply> localVarResp = requestServiceGetRequestsV2WithHttpInfo(from, to, currencyID, statuses, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, externalRequestIDs);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TgvalidatordGetRequestsV2Reply> requestServiceGetRequestsV2WithHttpInfo(OffsetDateTime from, OffsetDateTime to, String currencyID, List<String> statuses, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> externalRequestIDs) throws ApiException {
        okhttp3.Call localVarCall = requestServiceGetRequestsV2ValidateBeforeCall(from, to, currencyID, statuses, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, externalRequestIDs, null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetRequestsV2Reply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call requestServiceGetRequestsV2Async(OffsetDateTime from, OffsetDateTime to, String currencyID, List<String> statuses, List<String> types, List<String> ids, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String sortOrder, List<String> externalRequestIDs, final ApiCallback<TgvalidatordGetRequestsV2Reply> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = requestServiceGetRequestsV2ValidateBeforeCall(from, to, currencyID, statuses, types, ids, cursorCurrentPage, cursorPageRequest, cursorPageSize, sortOrder, externalRequestIDs, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetRequestsV2Reply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for requestServiceStakeETH
     * @param body  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call requestServiceStakeETHCall(TgvalidatordStakeETHRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/v1/requests/staking/eth_stake";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestServiceStakeETHValidateBeforeCall(TgvalidatordStakeETHRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling requestServiceStakeETH(Async)");
        }

        return requestServiceStakeETHCall(body, _callback);
     ...
     */
    public TgvalidatordCreateRequestReply requestServiceStakeETH(TgvalidatordStakeETHRequest body) throws ApiException {
        ApiResponse<TgvalidatordCreateRequestReply> localVarResp = requestServiceStakeETHWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordCreateRequestReply> requestServiceStakeETHWithHttpInfo(TgvalidatordStakeETHRequest body) throws ApiException {
        okhttp3.Call localVarCall = requestServiceStakeETHValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Stake ETH (asynchronously)
     * This endpoint will begin the process of staking on an ethereum address
     * @param body  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call requestServiceStakeETHAsync(TgvalidatordStakeETHRequest body, final ApiCallback<TgvalidatordCreateRequestReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestServiceStakeETHValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordCreateRequestReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param ids uint64; List of IDs to return (optional)
     * @param includeDetails If &#x60;true&#x60;, produce a verbose response (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
