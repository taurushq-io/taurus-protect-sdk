...
import com.taurushq.sdk.protect.openapi.model.TgvalidatordGetCryptoPunkMetadataReply;
...
public class TokenMetadataApi {
    ...
    /**
     * Build call for tokenMetadataServiceGetCryptoPunksTokenMetadata
     ...
     */
    public okhttp3.Call tokenMetadataServiceGetCryptoPunksTokenMetadataCall(String network, String contract, String token, String blockchain, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/rest/v1/evm/{network}/cryptopunks/contract/{contract}/token/{token}/metadata"
    ...
    private okhttp3.Call tokenMetadataServiceGetCryptoPunksTokenMetadataValidateBeforeCall(String network, String contract, String token, String blockchain, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'network' is set
        if (network == null) {
            throw new ApiException("Missing the required parameter 'network' when calling tokenMetadataServiceGetCryptoPunksTokenMetadata(Async)");
        }

        // verify the required parameter 'contract' is set
        if (contract == null) {
            throw new ApiException("Missing the required parameter 'contract' when calling tokenMetadataServiceGetCryptoPunksTokenMetadata(Async)");
        }

        // verify the required parameter 'token' is set
        if (token == null) {
            throw new ApiException("Missing the required parameter 'token' when calling tokenMetadataServiceGetCryptoPunksTokenMetadata(Async)");
        }

        return tokenMetadataServiceGetCryptoPunksTokenMetadataCall(network, contract, token, blockchain, _callback);
     ...
     */
    public TgvalidatordGetCryptoPunkMetadataReply tokenMetadataServiceGetCryptoPunksTokenMetadata(String network, String contract, String token, String blockchain) throws ApiException {
        ApiResponse<TgvalidatordGetCryptoPunkMetadataReply> localVarResp = tokenMetadataServiceGetCryptoPunksTokenMetadataWithHttpInfo(network, contract, token, blockchain);
     ...
     * @param token ID of the Punk. The ID can be between 0 and 9999. (required)
     * @param blockchain  (optional)
     * @return ApiResponse&lt;TgvalidatordGetCryptoPunkMetadataReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TgvalidatordGetCryptoPunkMetadataReply> tokenMetadataServiceGetCryptoPunksTokenMetadataWithHttpInfo(String network, String contract, String token, String blockchain) throws ApiException {
        okhttp3.Call localVarCall = tokenMetadataServiceGetCryptoPunksTokenMetadataValidateBeforeCall(network, contract, token, blockchain, null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetCryptoPunkMetadataReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get CryptoPunk metadata (asynchronously)
     * This endpoint returns the CryptoPunk metadata (image and attributes) for the provided punk ID.
     * @param network  (required)
     * @param contract Contract address: It should be &#39;0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB&#39; for ETH/mainnet (required)
     * @param token ID of the Punk. The ID can be between 0 and 9999. (required)
     ...
     */
    public okhttp3.Call tokenMetadataServiceGetCryptoPunksTokenMetadataAsync(String network, String contract, String token, String blockchain, final ApiCallback<TgvalidatordGetCryptoPunkMetadataReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = tokenMetadataServiceGetCryptoPunksTokenMetadataValidateBeforeCall(network, contract, token, blockchain, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetCryptoPunkMetadataReply>(){}.getType();
