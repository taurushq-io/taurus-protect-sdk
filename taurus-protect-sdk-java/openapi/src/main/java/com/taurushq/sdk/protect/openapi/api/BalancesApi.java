...
public class BalancesApi {
     ...
     * @param onlyPositiveBalance Whether or not to exclude collections with a zero balance. Defaults to false (collections with 0 balance included).  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call walletServiceGetNFTCollectionBalancesCall(String blockchain, String query, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String network, Boolean onlyPositiveBalance, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call walletServiceGetNFTCollectionBalancesValidateBeforeCall(String blockchain, String query, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String network, Boolean onlyPositiveBalance, final ApiCallback _callback) throws ApiException {
        return walletServiceGetNFTCollectionBalancesCall(blockchain, query, cursorCurrentPage, cursorPageRequest, cursorPageSize, network, onlyPositiveBalance, _callback);
     ...
     */
    public TgvalidatordGetNFTCollectionBalancesReply walletServiceGetNFTCollectionBalances(String blockchain, String query, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String network, Boolean onlyPositiveBalance) throws ApiException {
        ApiResponse<TgvalidatordGetNFTCollectionBalancesReply> localVarResp = walletServiceGetNFTCollectionBalancesWithHttpInfo(blockchain, query, cursorCurrentPage, cursorPageRequest, cursorPageSize, network, onlyPositiveBalance);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordGetNFTCollectionBalancesReply> walletServiceGetNFTCollectionBalancesWithHttpInfo(String blockchain, String query, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String network, Boolean onlyPositiveBalance) throws ApiException {
        okhttp3.Call localVarCall = walletServiceGetNFTCollectionBalancesValidateBeforeCall(blockchain, query, cursorCurrentPage, cursorPageRequest, cursorPageSize, network, onlyPositiveBalance, null);
     ...
     */
    public okhttp3.Call walletServiceGetNFTCollectionBalancesAsync(String blockchain, String query, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String network, Boolean onlyPositiveBalance, final ApiCallback<TgvalidatordGetNFTCollectionBalancesReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = walletServiceGetNFTCollectionBalancesValidateBeforeCall(blockchain, query, cursorCurrentPage, cursorPageRequest, cursorPageSize, network, onlyPositiveBalance, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetNFTCollectionBalancesReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
