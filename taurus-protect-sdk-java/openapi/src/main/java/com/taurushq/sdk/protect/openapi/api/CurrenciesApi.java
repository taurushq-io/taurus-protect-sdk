...
public class CurrenciesApi {
     ...
     * @param showDisabled Set this parameter to true to get all currencies,Include currencies disabled by business rules. (optional)
     ...
     * @param currencyID The unique identifier of a currency to filter by. (optional)
     * @param includeLogo Currency logos are omitted by default. Set this to true to include them when applicable. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
