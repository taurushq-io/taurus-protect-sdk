...
class InternalUserAttribute(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "value", "id", "contentType", "owner", "type", "subType", "isFile", "creationDate", "updateDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InternalUserAttribute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InternalUserAttribute from a dict"""
        if obj is None:
            return None
