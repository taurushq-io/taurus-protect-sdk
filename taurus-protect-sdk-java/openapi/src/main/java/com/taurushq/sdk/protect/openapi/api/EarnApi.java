...
public class EarnApi {
    ...
    /**
     * Build call for earnServiceGetRewards
     * @param recipientAddressId  (optional)
     ...
     */
    public okhttp3.Call earnServiceGetRewardsCall(String recipientAddressId, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/rest/v1/earn/rewards";
        ...
        if (recipientAddressId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("recipientAddressId", recipientAddressId));
        }
    ...
    private okhttp3.Call earnServiceGetRewardsValidateBeforeCall(String recipientAddressId, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, final ApiCallback _callback) throws ApiException {
        return earnServiceGetRewardsCall(recipientAddressId, cursorCurrentPage, cursorPageRequest, cursorPageSize, _callback);
     ...
     */
    public TgvalidatordGetEarnRewardsReply earnServiceGetRewards(String recipientAddressId, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize) throws ApiException {
        ApiResponse<TgvalidatordGetEarnRewardsReply> localVarResp = earnServiceGetRewardsWithHttpInfo(recipientAddressId, cursorCurrentPage, cursorPageRequest, cursorPageSize);
     ...
     * @param cursorPageRequest The page to request, w.r.t the current page. Can be one of &#x60;FIRST&#x60;, &#x60;PREVIOUS&#x60;, &#x60;NEXT&#x60;, &#x60;LAST&#x60; (optional)
     * @param cursorPageSize The size of the page requested. The handling service should impose a hard limit on this (optional)
     * @return ApiResponse&lt;TgvalidatordGetEarnRewardsReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TgvalidatordGetEarnRewardsReply> earnServiceGetRewardsWithHttpInfo(String recipientAddressId, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize) throws ApiException {
        okhttp3.Call localVarCall = earnServiceGetRewardsValidateBeforeCall(recipientAddressId, cursorCurrentPage, cursorPageRequest, cursorPageSize, null);
        Type localVarReturnType = new TypeToken<TgvalidatordGetEarnRewardsReply>(){}.getType();
     ...
     */
    public okhttp3.Call earnServiceGetRewardsAsync(String recipientAddressId, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, final ApiCallback<TgvalidatordGetEarnRewardsReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = earnServiceGetRewardsValidateBeforeCall(recipientAddressId, cursorCurrentPage, cursorPageRequest, cursorPageSize, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetEarnRewardsReply>(){}.getType();
