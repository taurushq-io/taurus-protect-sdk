...
class TgvalidatordCompanyTravelRuleData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["department", "buildingNumber", "street", "city", "province", "postalCode", "country", "legalEntityIdentifier", "businessName", "accountNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TgvalidatordCompanyTravelRuleData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TgvalidatordCompanyTravelRuleData from a dict"""
        if obj is None:
            return None
