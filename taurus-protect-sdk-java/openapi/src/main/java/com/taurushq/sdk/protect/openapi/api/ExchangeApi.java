...
public class ExchangeApi {
     ...
     * @param onlyPositiveBalance Whether or not to exclude an exchangeAccount with a zero balance. Defaults to false (exchangeAccounts with 0 balance included).  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call exchangeServiceGetExchangesCall(String currencyID, Boolean includeBaseCurrencyValuation, String exchangeLabel, String sortOrder, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, Boolean onlyPositiveBalance, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exchangeServiceGetExchangesValidateBeforeCall(String currencyID, Boolean includeBaseCurrencyValuation, String exchangeLabel, String sortOrder, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, Boolean onlyPositiveBalance, final ApiCallback _callback) throws ApiException {
        return exchangeServiceGetExchangesCall(currencyID, includeBaseCurrencyValuation, exchangeLabel, sortOrder, cursorCurrentPage, cursorPageRequest, cursorPageSize, status, onlyPositiveBalance, _callback);
     ...
     */
    public TgvalidatordGetExchangesReply exchangeServiceGetExchanges(String currencyID, Boolean includeBaseCurrencyValuation, String exchangeLabel, String sortOrder, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, Boolean onlyPositiveBalance) throws ApiException {
        ApiResponse<TgvalidatordGetExchangesReply> localVarResp = exchangeServiceGetExchangesWithHttpInfo(currencyID, includeBaseCurrencyValuation, exchangeLabel, sortOrder, cursorCurrentPage, cursorPageRequest, cursorPageSize, status, onlyPositiveBalance);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TgvalidatordGetExchangesReply> exchangeServiceGetExchangesWithHttpInfo(String currencyID, Boolean includeBaseCurrencyValuation, String exchangeLabel, String sortOrder, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, Boolean onlyPositiveBalance) throws ApiException {
        okhttp3.Call localVarCall = exchangeServiceGetExchangesValidateBeforeCall(currencyID, includeBaseCurrencyValuation, exchangeLabel, sortOrder, cursorCurrentPage, cursorPageRequest, cursorPageSize, status, onlyPositiveBalance, null);
     ...
     */
    public okhttp3.Call exchangeServiceGetExchangesAsync(String currencyID, Boolean includeBaseCurrencyValuation, String exchangeLabel, String sortOrder, String cursorCurrentPage, String cursorPageRequest, String cursorPageSize, String status, Boolean onlyPositiveBalance, final ApiCallback<TgvalidatordGetExchangesReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = exchangeServiceGetExchangesValidateBeforeCall(currencyID, includeBaseCurrencyValuation, exchangeLabel, sortOrder, cursorCurrentPage, cursorPageRequest, cursorPageSize, status, onlyPositiveBalance, _callback);
        Type localVarReturnType = new TypeToken<TgvalidatordGetExchangesReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
