...
// WhitelistedContract, and the list options and result that went with it, are gone:
// reads live on WhitelistedAssetService as model.WhitelistedAsset, which is the same
// server entity verified. What remains here serves the write paths.
//
// ApproveWhitelistedContractRequest, RejectWhitelistedContractRequest and
// DeleteWhitelistedContractRequest have no callers either — the service builds the
// generated request types directly — but they predate this change.
