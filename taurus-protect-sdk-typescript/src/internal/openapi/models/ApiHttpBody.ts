 ...
 */
export function instanceOfApiHttpBody(value: object): value is ApiHttpBody {
    return true;
}
...
export function ApiHttpBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiHttpBody {
  ...
  export function ApiHttpBodyToJSON(json: any): ApiHttpBody {
      return ApiHttpBodyToJSONTyped(json, false);
  }

  export function ApiHttpBodyToJSONTyped(value?: ApiHttpBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
